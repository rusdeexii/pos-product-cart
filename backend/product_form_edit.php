...
include('condb.php');  
include('h.php');//ไฟล์เชื่อมต่อกับ database ที่เราได้สร้างไว้ก่อนหน้าน้ี
$p_id = $_GET["ID"];
//2. query ข้อมูลจากตาราง:
$sql = "SELECT p.*,t.p_type_name
FROM product as p 
  ...
  <div class="row">
      ...
      <div class="form-group">
         ...
         <div class="form-group">
          <div class="col-sm-6">
            <p> ประเภทสินค้า </p>
            <select name="p_type_id" class="form-control" required>
              <option value="<?php echo $row["p_type_id"];?>">
                <?php echo $row["p_type_name"]; ?>
              </option>
        ...
        <div class="form-group">
          <div class="col-sm-12">
            <p> จำนวนในคลัง </p>
            <input type="text"  name="qty_onhand" class="form-control" required placeholder="จำนวนในคลัง" / value="<?php echo $qty_onhand; ?>">
          </div>
        </div>
            <div class="form-group">
          <div class="col-sm-12">
